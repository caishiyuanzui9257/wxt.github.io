...
public class loginService
{
	...
	public String login(String userName,String userPw,int userType)
	{
		...
		if(userType==1)
		{
			String sql="from TTea where zhuangtai='b' and del='no' and loginname=? and loginpw=?";
			Object[] con={userName,userPw};
		...
		if(userType==2)
		{
			String sql="from TUser where zhuangtai='b' and del='no' and loginname=? and loginpw=?";
			Object[] con={userName,userPw};
